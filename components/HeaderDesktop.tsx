          ...
          return (
            <li className="first:hidden group relative w-max" key={index}>
              <Link href={item.uri}>
                ...
                <span
                  className={`${
                    item.uri === pathname + "/" ? "!bg-[#C14C23] w-3/6" : ""
                  } absolute duration-500 -bottom-1 left-1/2 w-0 transition-all h-0.5 bg-white group-hover:w-3/6`}></span>
                <span
                  className={`${
                    item.uri === pathname + "/" ? "!bg-[#C14C23] w-3/6" : ""
                  } absolute duration-500 -bottom-1 right-1/2 w-0 transition-all h-0.5 bg-white group-hover:w-3/6`}></span>
              </Link>
            </li>
          );
        })}
